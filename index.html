...
<html>
    ...
    <body>
        ...
        <div class="section">
       <h1><span>Life of a software engineer</span></h1>
            <p>
                Hey! I'm <strong>isaac</strong>. Coding has changed my world. It's not just about apps. Learning to code gave me <i>problem-solving skills</i> and a way to communicate with others on a technical level. I can also develop websites and use my coding skills to get a better job. And I learned it all at <strong>www.justinestrada.com</strong> where he build your self-esteem and keep you motivated. Join me in this rewarding journey. You'll have fun, get help, and learn along the way!
            </p>
        ...
        <!-- My Skills section end -->
         ...
         <!-- Media section start -->
        <div class="section">
            <h1><span> Media Not available at the moment</span></h1>
